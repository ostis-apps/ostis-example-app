...
cp -Rfv $base_path/components/exercise/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/chemistry_components/exercise_ui_component.js
